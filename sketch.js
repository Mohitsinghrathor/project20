...
function createCash() {
  if (World.frameCount % 200 == 0) {
   // Modify the positions of cash 
    var cash = createSprite(Math.round(random(windowWidth/2+250,windowWidth/2-250),40, 10, 10));
...
function createDiamonds() {
  if (World.frameCount % 320 == 0) {
    ...
    var diamonds = createSprite(Math.round(random(windowWidth/2+250,windowWidth/2-250),40, 10, 10));
